...
export default function SelectProjectForPayment() {
  ...
  const handleSelect = () => {
    ...
    // ✅ الانتقال إلى صفحة المشروع مع فتح تبويب الدفعات
    navigate(`/projects/${selectedProjectId}?tab=payments`);
  };
      ...
      <div className="container" style={{ padding: "var(--space-6)" }}>
        <div style={{ marginBottom: "var(--space-6)" }}>
          <h1 style={{ fontSize: "24px", fontWeight: "600", marginBottom: "8px" }}>
            {t("select_project_for_payment") || "اختر مشروع لإضافة دفعة"}
          </h1>
          <p style={{ color: "var(--muted)", fontSize: "14px" }}>
            {t("select_project_for_payment_desc") || "اختر مشروعاً معتمداً نهائياً لإضافة دفعة"}
          </p>
        </div>
