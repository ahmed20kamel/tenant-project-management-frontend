...
export default function SelectProjectForVariation() {
  ...
  const handleSelect = () => {
    ...
    // ✅ الانتقال إلى صفحة المشروع مع فتح تبويب التغييرات السعرية
    navigate(`/projects/${selectedProjectId}?tab=variations`);
  };
      ...
      <div className="container" style={{ padding: "var(--space-6)" }}>
        <div style={{ marginBottom: "var(--space-6)" }}>
          <h1 style={{ fontSize: "24px", fontWeight: "600", marginBottom: "8px" }}>
            {t("select_project_for_variation") || "اختر مشروع لإضافة تغيير سعري"}
          </h1>
          <p style={{ color: "var(--muted)", fontSize: "14px" }}>
            {t("select_project_for_variation_desc") || "اختر مشروعاً معتمداً نهائياً لإضافة تغيير سعري"}
          </p>
        </div>
