...
export default function SelectProjectForStartOrder() {
      ...
      <div className="container" style={{ padding: "var(--space-6)" }}>
        <div style={{ marginBottom: "var(--space-6)" }}>
          <h1 style={{ fontSize: "24px", fontWeight: "600", marginBottom: "8px" }}>
            {t("select_project_for_start_order") || "اختر مشروع لإضافة أمر مباشرة"}
          </h1>
          <p style={{ color: "var(--muted)", fontSize: "14px" }}>
            {t("select_project_for_start_order_desc") || "اختر مشروعاً معتمداً نهائياً لإضافة أمر مباشرة"}
          </p>
        </div>
