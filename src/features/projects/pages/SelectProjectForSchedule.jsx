...
export default function SelectProjectForSchedule() {
  ...
  const handleSelect = () => {
    ...
    // ✅ الانتقال إلى صفحة المشروع مع فتح تبويب الجدول الزمني
    navigate(`/projects/${selectedProjectId}?tab=project_schedule`);
  };
      ...
      <div className="container" style={{ padding: "var(--space-6)" }}>
        <div style={{ marginBottom: "var(--space-6)" }}>
          <h1 style={{ fontSize: "24px", fontWeight: "600", marginBottom: "8px" }}>
            {t("select_project_for_schedule") || "اختر مشروع لإضافة الجدول الزمني"}
          </h1>
          <p style={{ color: "var(--muted)", fontSize: "14px" }}>
            {t("select_project_for_schedule_desc") || "اختر مشروعاً معتمداً نهائياً لإضافة الجدول الزمني"}
          </p>
        </div>
