...
export default function SelectProjectForInvoice() {
  ...
  const handleSelect = () => {
    ...
    // ✅ الانتقال إلى صفحة المشروع مع فتح تبويب الفواتير
    navigate(`/projects/${selectedProjectId}?tab=invoices`);
  };
      ...
      <div className="container" style={{ padding: "var(--space-6)" }}>
        <div style={{ marginBottom: "var(--space-6)" }}>
          <h1 style={{ fontSize: "24px", fontWeight: "600", marginBottom: "8px" }}>
            {t("select_project_for_invoice") || "اختر مشروع لإضافة فاتورة"}
          </h1>
          <p style={{ color: "var(--muted)", fontSize: "14px" }}>
            {t("select_project_for_invoice_desc") || "اختر مشروعاً معتمداً نهائياً لإضافة فاتورة"}
          </p>
        </div>
